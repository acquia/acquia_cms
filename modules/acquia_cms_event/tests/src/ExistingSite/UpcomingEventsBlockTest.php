...
class UpcomingEventsBlockTest extends ExistingSiteBase {
  ...
  protected function setUp() {
    ...
    $this->createNode([
      ...
      'field_event_end' => '2020-10-09T12:00:00',
      'moderation_state' => 'published',
    ]);
    $this->createNode([
      'type' => 'event',
      'title' => 'Event Example 2',
      'field_event_start' => '2020-09-13T22:00:00',
      'field_event_end' => '2020-09-16T12:00:00',
      'moderation_state' => 'published',
    ]);
    $this->createNode([
      'type' => 'event',
   ...
   *   greater than and equal to now and sort with
   *   event start date in Ascending order of the type under test.
   */
