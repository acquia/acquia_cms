...
class PostConfigExportCommandTest extends BrowserTestBase {
   ...
   * @var array
   */
  protected static $modules = ['acquia_cms_post_config_events_test'];
  ...
  public function testPostConfigExportEvents() {
    ...
    $this->assertSame($events, [
      "Drupal\\acquia_cms_post_config_events_test\\EventSubscriber\\TestAcquiaPostConfigExport::postConfigExport",
      "Drupal\\acquia_cms_post_config_events_test\\EventSubscriber\\TestPostConfigExport::postConfigExport",
    ]);
  }
