...
/home/travis/build/acquia/orca-build/vendor/bin/phpunit --verbose --colors=always --debug --exclude-group=orca_ignore,low_risk --configuration=/home/travis/build/acquia/orca-build/docroot/core/phpunit.xml --testsuite=orca
fi
