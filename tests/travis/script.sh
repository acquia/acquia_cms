...
if [ "$ACMS_JOB" = "base" ]; then
  ...
  '/home/travis/build/acquia/orca-build/vendor/bin/phpunit' '--verbose' '--colors=always' '--debug' '--configuration=/home/travis/build/acquia/acquia_cms/phpunit.xml' '--exclude-group=orca_ignore,site_studio' '--testsuite=orca'
fi
